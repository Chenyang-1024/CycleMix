...
def get_args_parser():
    ...
    # set your outputdir 
    parser.add_argument('--output_dir', default='./ACDC_cycleMix/',
...
def main(args):
    ...
    # starting with pytorch1.7, there's a new property allow_tf32. from pytorch1.7 to 1.11, it's True in default
    # while the versions >= pytorch1.12 are False in default.
